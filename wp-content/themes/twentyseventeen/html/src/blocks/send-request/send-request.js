/**
 * @file Implementation of the send request block.
 */

// -------------------------- BEGIN MODULE VARIABLES --------------------------

// Block name
const BLOCK_NAME = 'send-request';
...
/**
 * Initialize the send request block.
 *
...
export function initBlock() {
    ...
    let selector = document.getElementById("maskphone");
